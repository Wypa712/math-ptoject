...
function result() {
	...
	var elem1 = document.getElementById("t12");
	var elem2 = document.getElementById("t13");
	var elem3 = document.getElementById("t14");
	var elem4 = document.getElementById("t15");

	var res = `<b>${elem1.innerHTML}</b> ${elem2.innerHTML}<br>`
	...
	res = res + `<br><b>${elem3.innerHTML}</b> ${elem2.innerHTML}<br>`;
	for (let x = 0; x < kk2.length; x++) {
		var b = document.getElementById(kk2[x]);
		var c = kk02[x];
		if (b.style.background == "green") { res = res + document.getElementById(c).innerHTML; }
	}
	res = res + `<br><b>${elem4.innerHTML}</b> ${elem2.innerHTML}<br>`;
